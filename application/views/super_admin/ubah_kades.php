                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                            <h6 class="m-0 font-weight-bold text-info">Form Ubah Kades</h6>
                        </a>
                        <!-- Card Content - Collapse -->
                        <div class="collapse show" id="collapseCardExample">
                            <div class="card-body">

                                <?= form_open_multipart('Super_Admin/ubahKades/' . $rows['id_kades']); ?>
                                <input type="hidden" name="id_kades" value="<?= $rows['id_kades']; ?>">
                                <div class="form-group row">
                                    <label for="nama" class="col-lg-2 col-form-label">Nama</label>
                                    <div class="col-lg-7">
                                        <input type="text" class="form-control" id="nama" name="nama" autocomplete="off" value="<?= $rows['nama']; ?>">
                                    ...
                                    <div class="col-lg-7">
                                        <select class="form-control" id="jabatan" name="jabatan">
                                            <?php foreach ($jabatan as $j) : ?>
                                                <?php if ($j['kode_jabatan'] == $rows['jabatan']) : ?>
                                                    <option value="<?= $j['kode_jabatan']; ?>" selected><?= $j['deskripsi']; ?></option>
                                                <?php else : ?>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="awal" name="awal" placeholder="Tahun Awal" autocomplete="off" value="<?= $rows['awal']; ?>">
                                                    <?= form_error('awal', '<small class="form-text text-danger pl-2">', '</small>'); ?>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="akhir" name="akhir" placeholder="Tahun Akhir" autocomplete="off" value="<?= $rows['akhir']; ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <img src="<?= base_url('assets/img-kades/') . $rows['foto']; ?>" alt="oelatimo" class="img-thumbnail">
                                            </div>
                                            <div class="col-lg-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-7">
                                        <textarea class="form-control" id="pidato" name="pidato" rows="3"><?= $rows['pidato']; ?></textarea>
